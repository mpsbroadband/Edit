    ...
    public class when_writing_and_reading_back_a_snapshot
    {
        ...
        private Because of = () =>
        {
            ...
            _envelope = AssemblyContext.SnapshotStore.ReadAsync<StateOne>(_streamName, new CancellationToken()).Await()
                .AsTask.Result as TableStorageSnapshotEnvelope<StateOne>;
        };
        ...
        private It should_have_partition_key_in_envelope =
            () => _envelope.PartitionKey.ShouldEqual(_version.PartitionKey);
