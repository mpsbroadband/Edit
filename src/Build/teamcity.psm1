...
<!-- saved from url=(0069)https://raw.github.com/JamesKovacs/psake-contrib/master/teamcity.psm1 -->
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8"><style type="text/css"></style></head><body><pre style="word-wrap: break-word; white-space: pre-wrap;">if ($env:TEAMCITY_VERSION) {
